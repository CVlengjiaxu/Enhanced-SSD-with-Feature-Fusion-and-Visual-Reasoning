...
from nets import tensor_resize
...
def ssd_net(inputs,
    ...
    with tf.variable_scope(scope, 'ssd_300_vgg', [inputs], reuse=reuse):
        ...
        net7_net8 = slim.max_pool2d(net7_net8, [3, 3], stride=2, scope='net7_net8_mp')
        ...
        net8_net9 = slim.max_pool2d(net8_net9, [3, 3], stride=2, scope='net8_net9_mp')
        ...
        net9_net10 = slim.max_pool2d(net9_net10, [3, 3], stride=2, scope='net9_net10_mp')
        ...
        net10_net11 = slim.max_pool2d(net10_net11, [3, 3], stride=2, scope='net10_net11_mp', padding='VALID')
        net10_net11 = slim.conv2d(net10_net11, 256, [1, 1], scope='net10_net11')
        ...
        net11_net10 = slim.conv2d(net11_net10, 256, [1, 1], scope='net11_net10')
